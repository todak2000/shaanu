...
export const categoryArr = [
    { id: Crypto.randomUUID(), category: 'Food', icon: <MaterialCommunityIcons name="food-turkey" size={24} color={primaryRed} /> },
    { id: Crypto.randomUUID(), category: 'Utensils', icon: <FontAwesome5 name="utensils" size={24} color={primaryRed} /> },
    { id: Crypto.randomUUID(), category: 'Wears', icon: <Ionicons name="ios-watch" size={24} color={primaryRed} /> },
...
export const itemsArray = [
    {
        ...
        name:"Rice",
        imageUrl: ["https://upload.wikimedia.org/wikipedia/commons/6/60/OpenEuphoria_mascot_200px.png", "https://vignette4.wikia.nocookie.net/simpsons/images/0/01/200px-Langdon_Alger.png/revision/latest?cb=20120815160236", "https://picsum.photos/200",],
